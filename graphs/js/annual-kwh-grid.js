var annual_grid_energy = function annual_grid_energy(div) {
    ...
    d3.tsv("/www.retrofitanalysis.org/data/emissions.csv", function(error, data) {
        color.domain(["electrical_per_area", "gas_per_area"]);
        ...
        var property = svg.selectAll(".property")
            ...
            .on("mousemove", function() {
                return tooltip.style("top", (d3.event.pageY-10)+"px").style("left", (d3.event.pageX+10)+"px").html('Electrical per Area: ' + numberFormat(d3.event.currentTarget.__data__.electrical_per_area) + 'kWh/m<sup>2</sup><br />Gas per Area: ' + numberFormat(d3.event.currentTarget.__data__.gas_per_area) + 'kWh/m<sup>2</sup><br />Total Energy: ' + numberFormat(d3.event.currentTarget.__data__.energy_per_area) + 'kWh/m<sup>2</sup><br />' )
                // .style("height", "38px");
            })
        ...
        legend.append("text")
            ...
            .text(function(d) {
                console.log(d);
                return d == 'electrical_per_area'  ? 'Grid electricity' :
                    d == 'gas_per_area'  ?  'Grid Gas' :
                    'Unexpected Value';
            });
