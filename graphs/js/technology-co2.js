var technology_co2_emissions = function technology_co2_emissions(div, tech) {
    ...
    d3.tsv("/www.retrofitanalysis.org/data/emissions.csv", function(error, data) {
        ...
        property.selectAll("rect")
            ...
            .style("fill", function(d) {
                return d.data[tech] == "yes" ? color(d.name) : '#999'; });
    ...
    legend2.append("text")
        ...
        .attr("dy", ".35em")
        .style("text-anchor", "start")
        .text("Property does not have this technology");
